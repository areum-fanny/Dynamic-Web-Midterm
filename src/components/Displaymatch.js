...
function Displaymatch({ playerinfo, playerdata }) {
  return (
    <div>
      <div>
        <img
          src={`/images/profileicon/${playerinfo.player.profileIcon}.png`}
          alt="profileIcon"
        />
      ...
      <div>
        <a href={`/?itemid=${playerdata.stats.item0}`}>
          <img src={`/images/item/${playerdata.stats.item0}.png`} alt="Item0" />
        </a>
        <a href={`/?itemid=${playerdata.stats.item1}`}>
          <img src={`/images/item/${playerdata.stats.item1}.png`} alt="Item1" />
        </a>
        <a href={`/?itemid=${playerdata.stats.item2}`}>
          <img src={`/images/item/${playerdata.stats.item2}.png`} alt="Item2" />
        </a>
        <a href={`/?itemid=${playerdata.stats.item3}`}>
          <img src={`/images/item/${playerdata.stats.item3}.png`} alt="Item3" />
        </a>
        <a href={`/?itemid=${playerdata.stats.item4}`}>
          <img src={`/images/item/${playerdata.stats.item4}.png`} alt="Item4" />
        </a>
        <a href={`/?itemid=${playerdata.stats.item5}`}>
          <img src={`/images/item/${playerdata.stats.item5}.png`} alt="Item5" />
        </a>
