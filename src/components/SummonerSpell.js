const SummonerSpell = [
  {
    ...
    data: {
      ...
      SummonerDot: {
        ...
        costBurn: "0",
        datavalues: {},
        effect: [null, [5], [10], [4], [100], [0], [0], [0], [0], [0], [0]],
        effectBurn: [null, "5", "10", "4", "100", "0", "0", "0", "0", "0", "0"],
        vars: [
          {
            link: "@player.level",
            coeff: [
      ...
      SummonerExhaust: {
        ...
        tooltip:
          "Exhausts target enemy champion, reducing their Movement Speed by {{ f3 }}%, and their damage dealt by {{ f2 }}% for 3 seconds.",
        maxrank: 1,
        cooldown: [210],
        cooldownBurn: "210",
        cost: [0],
        costBurn: "0",
        datavalues: {},
        effect: [null, [3], [40], [0], [0], [30], [0], [0], [0], [0], [0]],
        effectBurn: [null, "3", "40", "0", "0", "30", "0", "0", "0", "0", "0"],
        vars: [],
        key: "3",
        summonerLevel: 4,
        modes: [
      ...
      SummonerTeleport: {
        ...
        tooltip:
          "After channeling for {{ channelduration }} seconds, your champion teleports to target allied structure, minion, or ward and grants a {{ movespeedbuff }} Movement Speed boost for {{ msduration }} seconds.",
        maxrank: 1,
        cooldown: [0],
        cooldownBurn: "0",
        cost: [0],
